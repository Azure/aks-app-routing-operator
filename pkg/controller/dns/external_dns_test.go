...
func TestInstances(t *testing.T) {
	...
	onlyPrivZonesPrivate, err := manifests.NewExternalDNSConfig(&onlyPrivZones, manifests.InputExternalDNSConfig{TenantId: onlyPrivZones.TenantID, ClientId: onlyPrivZones.MSIClientID, Namespace: onlyPrivZones.NS, IdentityType: manifests.IdentityTypeMSI, ResourceTypes: manifests.ResourceTypes{Ingress: true}, Provider: manifests.PrivateProvider, DnsZoneresourceIDs: util.Keys(onlyPrivZones.PrivateZoneConfig.ZoneIds)})
	require.NoError(t, err)
	...
	publicDeployPrivate, err := manifests.NewExternalDNSConfig(&onlyPubZones, manifests.InputExternalDNSConfig{TenantId: onlyPubZones.TenantID, ClientId: onlyPubZones.MSIClientID, Namespace: onlyPubZones.NS, IdentityType: manifests.IdentityTypeMSI, ResourceTypes: manifests.ResourceTypes{Ingress: true}, Provider: manifests.PrivateProvider, DnsZoneresourceIDs: util.Keys(onlyPubZones.PrivateZoneConfig.ZoneIds)})
	require.NoError(t, err)
	...
	allDeployPrivate, err := manifests.NewExternalDNSConfig(&allZones, manifests.InputExternalDNSConfig{TenantId: allZones.TenantID, ClientId: allZones.MSIClientID, Namespace: allZones.NS, IdentityType: manifests.IdentityTypeMSI, ResourceTypes: manifests.ResourceTypes{Ingress: true}, Provider: manifests.PrivateProvider, DnsZoneresourceIDs: util.Keys(allZones.PrivateZoneConfig.ZoneIds)})
	require.NoError(t, err)
...
func TestActionFromConfig(t *testing.T) {
	emptyDns, _ := manifests.NewExternalDNSConfig(&config.Config{}, manifests.InputExternalDNSConfig{TenantId: "tenant", ClientId: "client", Namespace: "ns", IdentityType: manifests.IdentityTypeMSI, ResourceTypes: manifests.ResourceTypes{Ingress: true}, Provider: manifests.PublicProvider, DnsZoneresourceIDs: []string{}})
	oneDns, _ := manifests.NewExternalDNSConfig(&config.Config{}, manifests.InputExternalDNSConfig{TenantId: "tenant", ClientId: "client", Namespace: "ns", IdentityType: manifests.IdentityTypeMSI, ResourceTypes: manifests.ResourceTypes{Ingress: true}, Provider: manifests.PublicProvider, DnsZoneresourceIDs: []string{"one"}})
	multipleDns, _ := manifests.NewExternalDNSConfig(&config.Config{}, manifests.InputExternalDNSConfig{TenantId: "tenant", ClientId: "client", Namespace: "ns", IdentityType: manifests.IdentityTypeMSI, ResourceTypes: manifests.ResourceTypes{Ingress: true}, Provider: manifests.PublicProvider, DnsZoneresourceIDs: []string{"one", "two"}})
