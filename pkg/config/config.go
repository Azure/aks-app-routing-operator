...
func init() {
	...
	flag.BoolVar(&Flags.EnableClientIpLogging, "enable-client-ip-logging", false, "enable logging the client IP for Ingress requests including the X-Forwarded-For header in the logs")
}
