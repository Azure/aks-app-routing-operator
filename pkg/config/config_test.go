...
var validateTestCases = []struct {
	...
	},
	{
		...
		Error: "both --default-domain-cert-path and --default-domain-key-path are required when --enable-default-domain is set",
	},
	{
		...
		Error: "--default-domain-cert-path and --default-domain-key-path are not allowed when --enable-default-domain is not set",
	},
	{
