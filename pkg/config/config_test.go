...
var validateTestCases = []struct {
	...
	{
		Name: "webhook service url but not webhook service",
		Conf: &Config{
			NS:                        "test-namespace",
			Registry:                  "test-registry",
			MSIClientID:               "test-msi-client-id",
			...
			OperatorNs:                "kube-system",
			OperatorDeployment:        "app-routing-operator",
			OperatorWebhookServiceUrl: "app-routing-operator-webhook.namespace.svc",
			WebhookPort:               9443,
			CertDir:                   "/certs",
			CrdPath:                   validCrdPath,
			CertName:                  "test-cert-name",
	...
	{
		Name: "webhook service url and webhook service",
		Conf: &Config{
			NS:                        "test-namespace",
			Registry:                  "test-registry",
			MSIClientID:               "test-msi-client-id",
		...
		Error: "only one of --operator-webhook-service or --operator-webhook-service-url should be specified",
	},
	{
	...
	},
	{
		...
		Error: "--operator-webhook-service or operator-webhook-service-url is required",
	},
	{
