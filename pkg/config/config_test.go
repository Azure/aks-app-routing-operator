...
var validateTestCases = []struct {
	...
	},
	{
		...
		Conf: &Config{
			...
			DefaultDomainKeyPath:     "./test_default_domain_key_path.txt",
	...
	},
	{
		...
		Conf: &Config{
			...
			DefaultDomainKeyPath:     "",
			DefaultDomainClientID:    "test-default-domain-client-id",
			DefaultDomainZoneID:      "/subscriptions/test-sub/resourceGroups/test-rg/providers/Microsoft.Network/dnszones/example.com",
		},
		Error: "--default-domain-cert-path, --default-domain-key-path, --default-domain-client-id, and --default-domain-zone-id are all required when --enable-default-domain is set",
	},
	{
		...
		Error: "--default-domain-cert-path, --default-domain-key-path, --default-domain-client-id, and --default-domain-zone-id are not allowed when --enable-default-domain is not set",
	},
	{
	...
	{
		Name: "invalid-enable-default-domain-missing-key-path",
		Conf: &Config{
			DefaultController:        Standard,
			NS:                       "test-namespace",
			Registry:                 "test-registry",
	...
	{
		Name: "invalid-enable-default-domain-missing-client-id",
		Conf: &Config{
			DefaultController:        Standard,
			NS:                       "test-namespace",
			Registry:                 "test-registry",
			...
			DefaultDomainCertPath:    "./test_default_domain_cert_path.txt",
			DefaultDomainKeyPath:     "./test_default_domain_key_path.txt",
			DefaultDomainClientID:    "",
			DefaultDomainZoneID:      "/subscriptions/test-sub/resourceGroups/test-rg/providers/Microsoft.Network/dnszones/example.com",
		},
		Error: "--default-domain-cert-path, --default-domain-key-path, --default-domain-client-id, and --default-domain-zone-id are all required when --enable-default-domain is set",
	},
	{
		Name: "invalid-enable-default-domain-missing-zone-id",
		Conf: &Config{
			DefaultController:        Standard,
			NS:                       "test-namespace",
			Registry:                 "test-registry",
