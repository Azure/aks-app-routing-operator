...
var validateTestCases = []struct {
	...
	{
		Name: "valid-enable-default-domain-with-server-address",
		Conf: &Config{
			DefaultController:          Standard,
			NS:                         "test-namespace",
			Registry:                   "test-registry",
			...
			DefaultDomainServerAddress: "https://default-domain-server.example.com",
	...
	},
	{
		...
		Conf: &Config{
			...
			EnableDefaultDomain:     true,
			EnabledWorkloadIdentity: true,
			DefaultDomainServerAddress: "",
			DefaultDomainClientID:   "test-default-domain-client-id",
			DefaultDomainZoneID:     "/subscriptions/test-sub/resourceGroups/test-rg/providers/Microsoft.Network/dnszones/example.com",
		},
		Error: "--default-domain-server-address, --default-domain-client-id, and --default-domain-zone-id are all required when --enable-default-domain is set",
	},
	{
		Name: "invalid-default-domain-server-address-without-enable",
		Conf: &Config{
			DefaultController:          Standard,
			NS:                         "test-namespace",
			Registry:                   "test-registry",
	...
	{
		Name: "valid-enable-default-domain-gateway-enabled",
		Conf: &Config{
			DefaultController:           Standard,
			NS:                          "test-namespace",
			Registry:                    "test-registry",
	...
	{
		Name: "valid-enable-default-domain-gateway-disabled",
		Conf: &Config{
			DefaultController:           Standard,
			NS:                          "test-namespace",
			Registry:                    "test-registry",
