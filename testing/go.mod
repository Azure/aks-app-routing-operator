module github.com/Azure/aks-app-routing-operator/testing

go 1.20

require (
	github.com/Azure/aks-app-routing-operator v0.0.2
	...
	github.com/Azure/azure-sdk-for-go/sdk/security/keyvault/azadmin v1.0.0
