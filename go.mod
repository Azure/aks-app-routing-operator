...
require (
	...
	github.com/open-policy-agent/gatekeeper/v3 v3.18.1 // waiting for gatekeeper to update to k8s packages 1.30+
...
require (
	...
	github.com/open-policy-agent/frameworks/constraint v0.0.0-20241101234656-e78c8abd754a // indirect
